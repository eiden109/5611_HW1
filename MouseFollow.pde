...
//     Change the program to draw a red circle with a black outline instead. -- DONE
...
//     very useful, be sure to check them out for general Processing help.) -- to represent diameter (the full size of the circle), rather than radius (half)
//  3. Change the background color to be white instead green. -- DONE
...
//      to the mouse's current position (mousePos). -- DONE
//  5. Try to get some keyboard input working:  
//        -When the user presses the 'd' key, double the speed the ball moves. 
//        -When the user presses the 'h' key, half the speed the ball moves. -- DONE
...
//     it 640 pixels across the screen. -- DONE
